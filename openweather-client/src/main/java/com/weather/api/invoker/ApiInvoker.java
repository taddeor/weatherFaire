package com.weather.api.invoker;
...
//    private Map<String, Authentication> authentications;
    ...
    private ApiInvoker(String basePath, RestTemplate restTemplate) {
        this.restTemplate = restTemplate==null?buildRestTemplate():restTemplate;
        this.basePath = basePath;
        init();
    }

    public static ApiInvoker from(String basePath, RestTemplate restTemplate){
        return new ApiInvoker(basePath,restTemplate);
    }
    ...
    private void init() {
        ...
        setUserAgent("Notification-client");
     ...
     */
    public ApiInvoker setUserAgent(String userAgent) {
